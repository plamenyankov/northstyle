...
elixir(function(mix) {
 ...
 mix.copy('node_modules/jquery-ui/jquery-ui.js',elixir.config.publicPath+'/js/jquery-ui.js');
 ...
 mix.copy('node_modules/jquery-ui/themes/base/jquery-ui.css',elixir.config.publicPath+'/css/jquery-ui.css');
 mix.copy('node_modules/simplemde/dist/simplemde.min.js',elixir.config.publicPath+'/js/simplemde.js');
 mix.scripts([
    'jquery.js','bootstrap.js','moment.js','simplemde.js','datepicker.js','jquery-ui.js'
 ]);
