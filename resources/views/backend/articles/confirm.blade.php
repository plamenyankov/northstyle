...
@section('content')
    {!! Form::open(['method'=>'delete','route'=>[fr('backend.blog.destroy'),$post->id]]) !!}
    <div class="alert alert-danger">
        <strong>Warning!</strong> You are about to delete post. This action cannot be undone. Are you sure you want to do this?
    </div>
